...
val LightLoginScreenColors = LoginScreenColors(
...
val DarkLoginScreenColors = LoginScreenColors(
...
val LocalLoginScreenColors = staticCompositionLocalOf { LightLoginScreenColors }
...
fun TripTrackTheme(
  ...
  val loginScreenColors = if (!useDarkTheme) {
    LightLoginScreenColors
  } else {
    DarkLoginScreenColors
  }

  CompositionLocalProvider(
      LocalLoginScreenColors provides loginScreenColors
  ) {
      MaterialTheme(
          colorScheme = colors,
          content = content
